package sasdevs.backend.exceptions;
...
public class GlobalExceptionHandler {
    ...
    // 403 - Доступ запрещен (теперь будет обрабатываться здесь) P.s. какого-то черта это работает в 500
    ...
    // 404 - Ресурс не найден (кастомное исключение)
    ...
    // 404 - Несуществующий URL (требует настройки в application.properties)
    ...
    public ResponseEntity<ErrorResponse> handleAllExceptions(Exception ex) {
        // Проверка на сообщение "Access denied"
